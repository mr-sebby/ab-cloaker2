function run(){
  ...
  if (url.length > 7){
    var w = window.open("https://allwordsinonepage.github.io/static/tiw/hvtrs8%2F-nmw%2Cge%2F", "_blank", "status=no,toolbar=no,location=no,directories=no,resizable=yes,scrollbars=yes,width=9999,height=9999");
